...
class TaskORM(Base):
    """One backend-created research task originating from a user query."""
...
class ArticleORM(Base):
    """Canonical normalized representation of one publication."""
...
class SourceRecordORM(Base):
    """Raw provider record retained for provenance and replay."""
...
class FullTextResourceORM(Base):
    """One discovered HTTP full-text representation for an article."""
