...
from app.core.llm_provider import create_chat_model
from app.prompts.intent_recognizer_prompt_template import INTENT_RECOGNIZER_SYSTEM_PROMPT_TEMPLATE
...
class IntentRecognizer:
    ...
    def __init__(self,model:BaseChatModel,system_prompt_template:str=INTENT_RECOGNIZER_SYSTEM_PROMPT_TEMPLATE):
        self._model = model
