...
from backend.app.core.intent_recognizer import IntentRecognitionResult, ResearchDirection
from backend.app.core.search_strategy_generator import SearchPlan, SearchSource
